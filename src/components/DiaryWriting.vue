...
<div class="writing" ref="capture">
 ...
 <!--그림그리는 영역 -->
   <div class="writing__drawing">
    <!-- 여기에 그린 그림 들어갈거임-->
    <!-- <canvas-drawing :image="image"></canvas-drawing> -->
    <canvas id="newlayer" ref="canvas" width="441px" height="307"></canvas> 
   </div>
 <!--그림그리는 영역 -->
